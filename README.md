...
The two are identical geometry today. `psu-enclosure` is the version that just
holds the supply; changes for the wider bench live here, so the working
enclosure stays printable while this one is in pieces. Diverge freely.

**This box contains mains wiring.** Read [Safety](#safety) before energising it.

## Room already in it

Nothing here needs adding to make space — the box was sized generously on
purpose and the slack is real:

| Where | Free space | Good for |
|---|---|---|
| Wiring bay, long side | 39 mm wide × 279 long, minus 12 mm where the plug flange intrudes | terminal blocks, a buck module for the fan, DC distribution |
...
| Ends and lid | untouched | the lid is a flat 285 × 201 plate; panel-mount anything to it |
...
adds a mm to the outside. Growing the box in X is capped by the 300 bed at about
290 including the pads; Y and Z have room.
